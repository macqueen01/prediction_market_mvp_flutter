...
class DejaTabBarView extends StatefulWidget {
  const DejaTabBarView({
    Key? key,
    required this.tabs,
...
class GlichuTabBarViewState extends State<DejaTabBarView>
...
class TopSafeArea {
  static final TopSafeArea instance = TopSafeArea._init();
